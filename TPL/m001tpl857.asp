  ...
  <tr> 
    <td colspan="4"> 
      <table width="653" border="0">
        <tr> 
          <td width="614" class="HdrReg"> from the Sirius Innovations Inc. through 
            PILAT. The PILAT Policy indicates that the loan agreement be reviewed 
            annually to ensure that the loan criteria and the student's 
      ...
      <table width="654" border="0">
        <tr> 
          <td width="617" class="HdrReg">Please contact the office to make arrangements 
            for a Review, by contacting your Si2 case manager to set 
            a date for the Review. If you have questions or concerns regarding 
            the loan or the Review, please feel free to contact me at (604) 959-8188 </td>
          <td width="26">&nbsp;</td>
        </tr>
      </table>
    </td>
