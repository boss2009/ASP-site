...
<html>
<head>
	<title>Student - Decline</title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<link rel="stylesheet" href="../css/MyStyle.css" type="text/css">
	<script language="Javascript" src="../js/MyFunctions.js"></script>
	<script language="Javascript">
	function Send(){
		if (!CheckEmail(document.frm1201.Recipient.value)) {
			alert("Invalid recipient email address.");
			document.frm1201.Recipient.focus();
			return ;
		}
		if (Trim(document.frm1201.Recipient.value) == "") {
			alert("Enter recipient email address.");
			document.frm1201.Recipient.focus();
			return ;
		}
		if (!CheckEmail(document.frm1201.Sender.value)) {
			alert("Invalid sender email address.");
			document.frm1201.Sender.focus();
			return ;
		}
		if (Trim(document.frm1201.Sender.value) == "") {
...
<table cellpadding="1" cellspacing="1">
	...
	<tr>
		<td>Subject:</td>
		<td><input type="text" name="Subject" size="75" value="Re: <%=Pilat_Decline_Referral_Type%>" tabindex="4">
	</tr>
<tr>		
