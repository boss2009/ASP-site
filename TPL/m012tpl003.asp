...
<html>
<head>
	<title>PILAT - Accept Consult/Training</title>
...
<br>
Re: <%=Pilat_Accept_Referral_Type%><br>
<p>
I am writing you with regards to your Temp referral application received by Sirius Innovations Inc.</p>
<%=Conditions%>
<p>
