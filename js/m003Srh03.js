//--------
// Description: singular items filter construct for Inventory Report
// caller : (1) m003r0101.asp
//
...
//        (6) chvStg2
//
//        Filter for (i) Institution   - Loan History
...
function ACfltr_03(chvOprd,chrNot,chvOptr,chvStg1,chvStg2) {
	...
	switch (chvOprd) {
		...
		break; 
		// Delivery date  + APR.22.2002
        case "48" :
			stgFilter += " h.dtsDlvy_date between '" + chvStg1 + "'" ;
		    stgFilter += " AND '" + chvStg2 + "'" ; 
		break;
		// Institution
        case "49" :
