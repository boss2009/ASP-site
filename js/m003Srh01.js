...
function ACfltr_03(chvOprd,chrNot,chvOptr,chvStg1,chvStg2) {
	var stgFilter = "" ;
		switch (chvOprd) {
			...
			break;
			// Serial No.
			case "42" :stgFilter += " chvSerial_Number " ;
				switch(chvOptr) {
			...
			// Delivery date
			case "48" :
				alert("Delivery Date Search is still under construction ..."); 
			break;
			// Institution
			case "49" :
				alert("Institution Search is still under construction ..."); 
			break;
			// Purchased by
			case "50" :
			...
			case "259" :stgFilter += " insUser_Type_id = 3 AND chvUsr_Fst_Name " ;
				switch(chvOptr) {
					case "1" : stgFilter += "LIKE '" + chvStg1 + "%25'  ";   break;
					case "2" : stgFilter += "LIKE '%25" + chvStg1 + "%25' "; break;
					case "3" : stgFilter += "= '"     + chvStg1 + "'  ";     break;
			...
			case "260" :stgFilter += " insUser_Type_id = 3 AND chvUsr_Lst_Name " ;
				switch(chvOptr) {
					case "1" : stgFilter += "LIKE '" + chvStg1 + "%25'  ";   break;
					case "2" : stgFilter += "LIKE '%25" + chvStg1 + "%25' "; break;
					case "3" : stgFilter += "= '"     + chvStg1 + "'  ";     break;
			...
			break;
			// Staff First name
			case "261" :stgFilter += " insUser_Type_id = 1 AND chvUsr_Fst_Name " ;
				switch(chvOptr) {
					case "1" : stgFilter += "LIKE '" + chvStg1 + "%25'  ";   break;
					case "2" : stgFilter += "LIKE '%25" + chvStg1 + "%25' "; break;
					case "3" : stgFilter += "= '"     + chvStg1 + "'  ";     break;
			...
			break;
			// Staff Last name
			case "262" :stgFilter += " insUser_Type_id = 1 AND chvUsr_Lst_Name " ;
				switch(chvOptr) {
					case "1" : stgFilter += "LIKE '" + chvStg1 + "%25'  ";   break;
					case "2" : stgFilter += "LIKE '%25" + chvStg1 + "%25' "; break;
					case "3" : stgFilter += "= '"     + chvStg1 + "'  ";     break;
