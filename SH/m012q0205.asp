...
rsPILATStudent.Source = "{call dbo.cp_pilat_stdsch_ref(0,"+ Request.QueryString("intReferral_id") + ",0,0,'Q',0)}";
...
<table cellspacing="1">
	...
	<tr>
		<td colspan="4">Displaying Records <%=rsPILATStudent_first%> To <%=rsPILATStudent_last%> Of <%=rsPILATStudent_total%></td>
	</tr>
</table>
<hr>
...
%>
    <tr>
		<td nowrap><a href="javascript: openWindow('../PS/m022FS3.asp?intPStdnt_id=<%=(rsPILATStudent.Fields.Item("intPStdnt_id").Value)%>');"><%=rsPILATStudent.Fields.Item("chvLst_name").Value%>, <%=rsPILATStudent.Fields.Item("chvFst_name").Value%></a>&nbsp;</td>
		<td nowrap><a href="javascript: openWindow('m012q0205x.asp?intReferral_id=<%=Request.QueryString("intReferral_id")%>&intPEnroll_id=<%=(rsPILATStudent.Fields.Item("intPEnroll_id").Value)%>');"><img src="../i/remove.gif" ALT="Remove <%=rsPILATStudent.Fields.Item("chvLst_name").Value%>, <%=rsPILATStudent.Fields.Item("chvFst_name").Value%>"></a></td>
    </tr>
<%
	Repeat1__index++;
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><a href="javascript: openWindow('m012p0401.asp?intReferral_id=<%=Request.QueryString("intReferral_id")%>','winAdd');">Add PILAT Student</a></td>
	</tr>
</table>
</body>
</html>
