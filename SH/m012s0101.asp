...
<html>
<head>
	<title>Institution - Quick Search</title>
	...
	function CnstrFltr(output) {
		...
		if (output==1) {
			...
			document.frm12s01.action = "m012q01excel.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter;
			document.frm12s01.target = "_blank";
...
<h3>Institution - Quick Search</h3>
<hr>
...
<table cellpadding="1" cellspacing="1">
	...
	<tr>
		<td>
	        <input type="submit" value="Search" tabindex="15" onClick="CnstrFltr(1);" class="btnstyle">
			<input type="button" value="Excel" tabindex="16" onClick="CnstrFltr(2);" class="btnstyle">
