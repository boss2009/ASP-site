...
<head>
	...
	function Init() {
		...
		selectChange(frm14p02.Operand, frm0103.Operator,detailData);
	<%
	if (String(Request.QueryString("Search")) == "true") { 		
	%>
	...
	function SelectClient(){
		...
		opener.document.frm14a0201.ClientID.value=document.frm14p02.SearchResult[document.frm14p02.SearchResult.selectedIndex].value;
		opener.document.frm14a0201.ClientName.value=document.frm14p02.SearchResult.options[document.frm14p02.SearchResult.selectedIndex].text;
		self.close();
	}
	</script>
</head>
