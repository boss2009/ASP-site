...
<table cellspacing="1">
    <tr> 
		<td nowrap align="left" width="350">Displaying Records <b><%=(rsBundle_first)%></b> to <b><%=(rsBundle_last)%></b> of <b><%=(rsBundle_total)%></b></td>
		<td nowrap><a href="javascript: openWindow('m005a0101.asp','wQA06');">Add Equipment Bundle</a></td>
    </tr>
</table>
<div class="BrowsePanel" style="height: 295px; width: 100%">
<table cellpadding="2" cellspacing="1">
	<tr> 
		<th nowrap class="headrow" align="left" width="300">Bundle Name</th>
		<th nowrap class="headrow" align="center" width="100">List Unit Cost</th>
