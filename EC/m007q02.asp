...
<table cellspacing="1">
    <tr> 
		<td align="left" width="370">Displaying Records <b><%=(rsEquipmentClass_first)%></b> to <b><%=(rsEquipmentClass_last)%></b> of <b><%=(rsEquipmentClass_total)%></b></td>
...
<table cellpadding="2" cellspacing="1">
	<tr> 
		<th width="400" class="headrow" align="left">Class Name</th>
        <th width="140" class="headrow" align="center">Class Type</th>
	</tr>
<% 
while ((Repeat1__numRows-- != 0) && (!rsEquipmentClass.EOF)) {
%>
	<tr> 
<% 
	switch(rsEquipmentClass.Fields.Item("chrClass_Type").Value){ 
		case 'A': 
%>
        <td><a href="javascript: EditClass(<%=(rsEquipmentClass.Fields.Item("insEquip_Class_id").Value)%>,'A')"><%=(rsEquipmentClass.Fields.Item("chvClass_Name").Value)%></a></td>
        <td align="center">Abstract</td>
<%
		break;
		case 'S':
%>
        <td><a href="javascript: EditClass(<%=(rsEquipmentClass.Fields.Item("insEquip_Class_id").Value)%>,'S')"><%=(rsEquipmentClass.Fields.Item("chvClass_Name").Value)%></a></td>
        <td align="center">Sub Abstract</td>
<%
		break;
		case 'C':
%>
        <td><a href="javascript: EditClass(<%=(rsEquipmentClass.Fields.Item("insEquip_Class_id").Value)%>,'C')"><%=(rsEquipmentClass.Fields.Item("chvClass_Name").Value)%></a></td>
