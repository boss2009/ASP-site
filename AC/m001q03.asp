...
rsClient.Source = "{call dbo.cp_Adult_Client3A("+ Request.QueryString("inspSrtBy") + ","+ Request.QueryString("inspSrtOrd") + ",'"+ rsClient__chvFilter.replace(/'/g, "''") + "')}";
...
<head>
	...
	function JumpRecord(){
		if (document.frmq03.JumpToRecord.value=="") {
...
<table cellspacing="1">
    <tr> 
		...
		<td nowrap><a href="javascript: openWindow('m001a0101a.asp?intAdult_id=<%=Request.QueryString("intAdult_id")%>','wQA01');">Add Client</a></td>
    </tr>
</table>
<div class="BrowsePanel" style="height: 339px; width: 800px"> 
