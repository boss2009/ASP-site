...
rsClient.Source = "{call dbo.cp_Adult_Client6("+ Request.QueryString("inspSrtBy") + ","+ Request.QueryString("inspSrtOrd") + ",'"+ rsClient__chvFilter.replace(/'/g, "''") + "',0)}";
...
<head>
	...
	function JumpRecord(){
		if (document.frm1001.JumpToRecord.value=="") {
			alert("Enter Record Number.");
		}
		if (!IsID(document.frm1001.JumpToRecord.value)) {
			alert("Invalid Record Number.");
		} else {
			window.location.href="..<%Response.Write(Request.ServerVariables("URL") + "?" + MM_keepMove + MM_moveParam + "=")%>"+String(document.frm1001.JumpToRecord.value-1);
		}
	}			
...
<table cellspacing="1">
  ...
  <div class="BrowsePanel" style="width: 100%; height: 420px"> 
...
%>
      <tr> 
        ...
        <td nowrap><%=FormatPhone(rsClient.Fields.Item("chvPhone_no").Value)%>&nbsp;</td>
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td width="900"><a href="javascript: openWindow('m001a0101.asp','wQA01');">Add Client</a></td>
