<%@language="JAVASCRIPT"%>
<!--#include virtual="/inc/ASPUtility.inc" -->
<!--#include virtual="/inc/ASPCheckLogin.inc" -->
<!--#include virtual="/Connections/cnnASP02.asp" -->
...
//----------------------------------
	...
	cmdSummary.CommandText = "dbo.cp_AdtClnt_SrvNote_Rpt_03A";
	...
	cmdSummary.Parameters.Append(cmdSummary.CreateParameter("@intUnq_AdtClnt_Rec_Cnt",  3, 2));
