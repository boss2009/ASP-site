...
rsMailList.Source = "{call dbo.cp_Mail_List(0,'',0,0,'Q',0)}";
...
<html>
<head>
	<title>Mail List Lookup Table</title>
...
%>
	<tr> 
      <td><a href="m018e03124.asp?insMail_list_id=<%=(rsMailList.Fields.Item("insMail_list_id").Value)%>"><%=FilterQuotes(rsMailList.Fields.Item("chvName").Value)%></a></td>
      <td align="center"><%=(rsMailList.Fields.Item("bitIs_active").Value)%></td>		
    </tr>
<%
	Repeat1__index++;
	rsMailList.MoveNext();
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><a href="javascript: openWindow('m018a03124.asp','w18a03124');">Add Mail List</a></td>
	</tr>
</table>
</body>
</html>
