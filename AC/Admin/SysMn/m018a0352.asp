...
if (String(Request("MM_insert")) != "undefined") {
  ...
  var MM_editTable  = "dbo.tbl_attachment";
...
<head>
	...
	function Save(){
		if (Trim(document.frm0352.Description.value)=="") {
			alert("Enter Description.");
			document.frm0352.Description.focus();
			return ;
		}
		document.frm0352.submit();
	}
	</script>	
</head>
<body onLoad="document.frm0352.Description.focus();">
<form name="frm0352" method="POST" action="<%=MM_editAction%>">
