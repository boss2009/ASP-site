...
if (String(Request("MM_update")) != "undefined" &&
  ...
  var MM_editColumn = "insAttachment_id";
  var MM_recordId = "" + Request.Form("MM_recordId") + "";
  var MM_editRedirectUrl = "m018q0352.asp";
...
rsAttachment.Source = "{call dbo.cp_attachment("+ Request.QueryString("insAttachment_id") + ",1)}";
...
<html>
<head>
	<title>Update Attachment Lookup</title>
...
<h5>Update Attachment Lookup</h5>
<hr>
<table cellpadding="1" cellspacing="1">
    <tr> 
		<td>Description:</td>
		<td><input type="text" name="Description" value="<%=(rsAttachment.Fields.Item("chvName").Value)%>" maxlength="40" size="40" tabindex="1" accesskey="F"></td>
    </tr>
</table>
<hr>
<table cellpadding="1" cellspacing="1">
...
<input type="hidden" name="MM_recordId" value="<%= rsAttachment.Fields.Item("insAttachment_id").Value %>">
</form>
</body>
</html>
<%
