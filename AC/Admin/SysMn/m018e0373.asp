...
if (String(Request("MM_update")) != "undefined" &&
  ...
  var MM_editTable  = "dbo.tbl_pricing_qty";
  var MM_editColumn = "insPrice_qty_id";
  var MM_recordId = "" + Request.Form("MM_recordId") + "";
  var MM_editRedirectUrl = "m018q0373.asp";
...
rsPricingQuantity.Source = "{call dbo.cp_Get_pricing_qty("+ Request.QueryString("insPrice_qty_id") + ",1)}";
...
<html>
<head>
	<title>Update Pricing Quantity Lookup</title>
	...
	function Save(){
		if (Trim(document.frm0373.Description.value)==""){
			alert("Enter Description.");
			document.frm0373.Description.focus();
			return ;		
		}
		document.frm0373.submit();
	}
	</script>	
</head>
<body onLoad="document.frm0373.Description.focus();">
<form name="frm0373" method="POST" action="<%=MM_editAction%>">
<h5>Update Pricing Quantity Lookup</h5>
<hr>
<table cellpadding="1" cellspacing="1">
    <tr> 
		<td>Description:</td>
		<td><input type="text" name="Description" value="<%=(rsPricingQuantity.Fields.Item("chvName").Value)%>" maxlength="50" size="30" tabindex="1" accesskey="F" ></td>
    </tr>
</table>
<hr>
<table cellpadding="1" cellspacing="1">
...
<input type="hidden" name="MM_recordId" value="<%= rsPricingQuantity.Fields.Item("insPrice_qty_id").Value %>">
</form>
</body>
</html>
<%
