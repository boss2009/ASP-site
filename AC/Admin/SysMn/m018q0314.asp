...
rsRelationship.Source = "{call dbo.cp_relationship2(0,'',0,0,0,'Q',0)}";
...
if (rsRelationship_total == -1) {
  ...
  if (rsRelationship.CursorType > 0) {
    if (!rsFS.BOF) rsRelationship.MoveFirst();
  } else {
...
<html>
<head>
	<title>Relationship Lookup Table</title>
...
<body>
<h5>Relationship Lookup Table</h5>
...
<table cellpadding="2" cellspacing="1" class="Mtable">
    <tr> 
		...
		<th class="headrow" align="center">Type</th>
    </tr>
    <% 
	while ((Repeat1__numRows-- != 0) && (!rsRelationship.EOF)) { 
	%>
    <tr> 
		<td><a href="m018e0314.asp?insRtnship_id=<%=(rsRelationship.Fields.Item("insRtnship_id").Value)%>"><%=(rsRelationship.Fields.Item("chvRtnship").Value)%></a></td>
		<td align="center"><%=(rsRelationship.Fields.Item("bitis_active").Value)%></td>
		<td align="center"><%=(rsRelationship.Fields.Item("chvRelationship_type").Value)%></td>
    </tr>
	<%
		Repeat1__index++;
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><a href="javascript: openWindow('m018a0314.asp','w18A0314');">Add Relationship</a></td>
	</tr>
</table>
</body>
</html>
