...
if (String(Request("MM_insert")) != "undefined") {
  ...
  var MM_fieldsStr = "Description|value|IsAdultDisability|value|IsActive|value";
...
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="frm0309">
<h5>New Disability</h5>
<hr>
<table cellpadding="1" cellspacing="1">
    ...
    <tr> 
		<td>Adult Disability:</td>
		<td><input type="checkbox" name="IsAdultDisability" value="1" tabindex="2" class="chkstyle"></td>
	 </tr>
	 <tr>
		<td>Is Active:</td>
		<td><input type="checkbox" name="IsActive" value="1" tabindex="3" accesskey="L" class="chkstyle"></td>
    </tr>
</table>
<hr>
<table cellpadding="1" cellspacing="1">
