...
rsCompany.Source = "{call dbo.cp_Company(0,0)}";
...
<html>
<head>
	<title>Company Lookup Table</title>
...
%>
    <tr> 
		<td><a href="m018e0303.asp?intCompany_id=<%=(rsCompany.Fields.Item("intCompany_id").Value)%>"><%=(rsCompany.Fields.Item("chvname").Value)%></a></td>
    </tr>
<%
	Repeat1__index++;
	rsCompany.MoveNext();
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><a href="javascript: openWindow('m018a0303.asp','w18A0303');">Add Company</a></td>
	</tr>
</table>
</body>
</html>
