...
if (String(Request("MM_insert")) == "true") {
	...
	rsNote.Source = "{call dbo.cp_ac_srv_note("+Request.QueryString("intAdult_id")+",0,'"+Request.Form("Date")+"',0,0,"+Request.Form("ServiceProvider")+",'"+Notes+"','"+Request.Form("NoteTypeHexCode")+"',1,'A',0)}";
	rsNote.CursorType = 0;
...
<head>
	...
	function Save(){
		...
		for (var i=0; i < document.frm1202.NoteType.length; i++){
			if (document.frm1202.NoteType[i].selected) temp = temp + PadDecToHex(document.frm1202.NoteType[i].value);
		}
...
<body onLoad="javascript:document.frm1202.Date.focus()" >
<form action="<%=MM_editAction%>" method="POST" name="frm1202">
<h5>New Notes</h5>
<i>To select multiple Note Type, press and hold the [Ctrl] key.</i>
<hr>
<table cellpadding="1" cellspacing="1">
    ...
    <tr>
		...
		<td nowrap valign="top"><textarea name="Notes" rows="8" cols="65" tabindex="4" accesskey="L"></textarea></td>
    </tr>
</table>
<hr>
<table cellpadding="1" cellspacing="1">
