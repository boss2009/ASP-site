...
<table cellspacing="1">
	...
	<tr>
		<td colspan="4">Displaying Records <%=rsLoan_first%> To <%=rsLoan_last%> Of <%=rsLoan_total%></td>
	</tr>	
</table>
<hr>
<table cellspacing="1" cellpadding="2" class="Mtable">
	<tr> 
		...
		<th nowrap class="headrow" align="left">Date Delivered</th>		
		...
		<th nowrap class="headrow" align="left">Inventory Date</th>
		<th nowrap class="headrow" align="left">PR Number</th>				
		<th nowrap class="headrow" align="left" width="200">Vendor</th>
		<th nowrap class="headrow" align="left">Loan Request</th>
    </tr>
<%
var temp = 0;
var temp2 = 0;
...
%>
    <tr> 
		<td nowrap valign="top"><a href="javascript: openWindow('../LN/m008FS3.asp?intLoan_Req_id=<%=(rsLoan.Fields.Item("intLoan_Req_id").Value)%>','');"><%=Truncate(rsLoan.Fields.Item("chvInventory_Name").Value,40)%></a></td>	
		<td nowrap align="center" valign="top"><%=FilterDate(rsLoan.Fields.Item("dtsProcess").Value)%></td>
		<td nowrap align="center" valign="top"><%=FilterDate(rsLoan.Fields.Item("dtsDate_Shipped").Value)%></td>		
		<td nowrap align="center" valign="top"><%=FilterDate(rsLoan.Fields.Item("dtsReturn").Value)%></td>
		<td nowrap align="center" valign="top"><%=ZeroPadFormat(rsLoan.Fields.Item("intEquip_Set_id").Value,8)%></td>
		<td nowrap align="left" valign="top"><%=(rsLoan.Fields.Item("chvequip_status").Value)%></td>
		<td nowrap align="right" valign="top"><%=FormatCurrency(rsLoan.Fields.Item("fltPurchase_Cost").Value)%></td>
		<td nowrap align="center" valign="top"><%=FilterDate(rsLoan.Fields.Item("dtsRec_Date").Value)%></td>		
		<td nowrap align="center" valign="top"><%=ZeroPadFormat(rsLoan.Fields.Item("intRequisition_no").Value,8)%></td>
		<td nowrap align="left" valign="top"><%=(rsLoan.Fields.Item("chvDtlVendor").Value)%></td>		
		<td nowrap align="center" valign="top"><%=ZeroPadFormat(rsLoan.Fields.Item("intLoan_Req_id").Value,8)%></td>		
    </tr>
<%
	Repeat1__index++;
	rsLoan.MoveNext();
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><a href="javascript: openWindow('m001pop3.asp?intAdult_id=<%=Request.QueryString("intAdult_id")%>');">Summary</a></td>
	</tr>
</table>
</body>
</html>
