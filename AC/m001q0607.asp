...
rsDisability.Source = "{call dbo.cp_dsbty_doc("+Request.QueryString("intAdult_id")+")}";
...
rsEducation.Source = "{call dbo.cp_edu_doc2("+Request.QueryString("intAdult_id")+", 0,2,0)}";
//rsEducation.Source = "{call dbo.cp_edu_doc("+Request.QueryString("intAdult_id")+")}";
...
rsExternalAgency.Source = "{call dbo.cp_Ext_FS("+Request.QueryString("intAdult_id")+")}";
...
rsGrantEligibility.Source = "{call dbo.cp_grant_elgbty3(0,"+Request.QueryString("intAdult_id")+",0,2,'Q',0)}";
...
<html>
<head>
	<title>Documentation & Eligibility Summary</title>
...
<body>
<h5>Documentation & Eligibility Summary</h5>
...
%>
	<tr>
		<td style="border: 1px solid" align="left"><%=(rsGrantEligibility.Fields.Item("chvGrant_list").Value)%>&nbsp;</td>
