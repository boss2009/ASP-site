...
<html>
<head>
	<title>Client - Power Search</title>
	...
	function CnstrFltr(output) {
		...
		if (output==1) {
			document.frm01s01.action = "m001q03.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter ;
			document.frm01s01.submit(); 
		} else {
			var ExcelSearch = window.open("m001q03excel.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter);
		}
	}
...
<table cellpadding="1" cellspacing="1" border="0">
    <tr> 
		...
		<td nowrap valign="top" colspan="2"><DIV ID="oOptr3" STYLE="visibility:hidden"> 
			contains: <select name="MultiValueSearchText" size="8" width="150" multiple align="top" tabindex="13"></select>
		</DIV></td>
    </tr>
</table>
<table cellpadding="1" cellspacing="1">
