...
<table cellspacing="1">
	...
	<tr>
		<td colspan="4">Displaying Records <%=rsBuyout_first%> To <%=rsBuyout_last%> Of <%=rsBuyout_total%></td>
	</tr>	
</table>
<hr>
<table cellpadding="2" cellspacing="1" class="Mtable">
    <tr> 
		<th nowrap class="headrow" align="left" width="220">Inventory Name</th>	
		...
		<th nowrap class="headrow" align="left">Inventory Sold</th>
		<th nowrap class="headrow" align="left">Buyout Request</th>				
    </tr>
<% 
while ((Repeat1__numRows-- != 0) && (!rsBuyout.EOF)) { 
%>
    <tr>
		<td nowrap><a href="javascript: openWindow('../BO/m010FS3.asp?intBuyout_Req_id=<%=(rsBuyout.Fields.Item("intBuyout_Req_id").Value)%>','w010E01');"><%=Truncate(rsBuyout.Fields.Item("chvInventory_Name").Value,40)%></a></td>	
		<td nowrap valign="top" align="center"><%=FilterDate(rsBuyout.Fields.Item("dtsProcess").Value)%></td>
<!-- + Oct.28.2005
		<td nowrap valign="top" align="center"><%=FilterDate(rsBuyout.Fields.Item("dtsDlvy_date").Value)%></td>		
-->
		...
		<td nowrap valign="top" align="center"><%=(rsBuyout.Fields.Item("chvequip_status").Value)%></td>			
		<td nowrap valign="top" align="left"><%=(rsBuyout.Fields.Item("chvDtlVendor").Value)%></td>
		<td nowrap valign="top" align="center"><%=ZeroPadFormat(rsBuyout.Fields.Item("intRequisition_no").Value,8)%></td>
		<td nowrap valign="top" align="center"><%=FilterDate(rsBuyout.Fields.Item("dtsRec_Date").Value)%></td>				
		<td nowrap valign="top" align="right"><%=FormatCurrency(rsBuyout.Fields.Item("fltPurchase_Cost").Value)%></td>
		<td nowrap valign="top" align="right"><%=FormatCurrency(rsBuyout.Fields.Item("fltEqp_Sold_price").Value)%></td>
		<td nowrap valign="top" align="center"><%=ZeroPadFormat(rsBuyout.Fields.Item("intBuyout_Req_id").Value,8)%></td>			
    </tr>
<%
	Repeat1__index++;
	rsBuyout.MoveNext();
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><a href="javascript: openWindow('m001pop4-2.asp?intAdult_id=<%=Request.QueryString("intAdult_id")%>');">Summary</a></td>
	</tr>
</table>
</body>
</html>
