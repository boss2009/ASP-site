...
<table cellpadding="1" cellspacing="1">
	...
	<tr>
		<td>
			<input type="button" value="Select Class" tabindex="5" onClick="SelectClass(document.frm14p02.SearchResult[document.frm14p02.SearchResult.selectedIndex].value,document.frm14p02.SearchResult.options[document.frm14p02.SearchResult.selectedIndex].text);" <%=((count==0)?"DISABLED":"")%> class="btnstyle">
