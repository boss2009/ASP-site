...
<head>
	...
	function selectChange(control, controlToPopulate,ItemArray) {
		document.frm14p02.TextBoxOne.value="";
		document.frm14p02.TextBoxTwo.value="";
		var myEle ;
		for (var q=controlToPopulate.options.length;q>=0;q--) controlToPopulate.options[q]=null;
		myEle = document.createElement("option") ;
		var y = control.value;
		if ((y == "18") || (y == "22")){
			document.frm14p02.TextBoxTwo.disabled = false;
			oStg2.style.visibility = "visible";
		} else {
			document.frm14p02.TextBoxTwo.disabled = true;
			oStg2.style.visibility = "hidden";
		}
		if (y == "17") {
	...
	function CnstrFltr() {
		...
		var chvStg1 = document.frm14p02.TextBoxOne.value;
		var chvStg2 = document.frm14p02.TextBoxTwo.value;

		if (((chvOprd=="18") || (chvOprd=="22")) && (chvOptr!="0")) {
			if (chvStg1 == "") {
				alert("Enter Start Date");
				document.frm14p02.TextBoxOne.focus();
				return ;
			}
			if (chvStg2 == "") {
				alert("Enter End Date");
				document.frm14p02.TextBoxTwo.focus();
				return ;
			}
		...
		if (chvOptr == "0") {
			...
			stgPgQuery += "m014p0202.asp?Search=true&inspSrtBy=1&inspSrtOrd=0&chvFilter=" + stgFilter ;
		}
	...
	function SelectClient(){
		...
		opener.document.frm14s01.ClientSearchID.value=document.frm14p02.SearchResult[document.frm14p02.SearchResult.selectedIndex].value;
		opener.document.frm14s01.ClientSearchText.value=document.frm14p02.SearchResult.options[document.frm14p02.SearchResult.selectedIndex].text;
		self.close();
	}
	</script>
</head>
...
<table cellpadding="1" cellspacing="1">
	<tr> 
		...
		<td nowrap><DIV ID="oStg1" STYLE="visibility:visible">
			<input type="text" name="TextBoxOne" tabindex="4">
		</DIV></td>
		<td nowrap><DIV ID="oStg2" STYLE="visibility:hidden"><input type="text" name="TextBoxTwo" tabindex="5" DISABLED accesskey="L"></DIV></td>
	</tr>
	<tr>
