...
<head>
	...
	function CnstrFltr() {
		...
		stgPgQuery = "m014p0101.asp?insPurchase_req_id=<%=Request.QueryString("insPurchase_req_id")%>&insRqst_requested_id=<%=Request.QueryString("insRqst_requested_id")%>&";
	...
	%>
			top.opener.document.frm0201.action = "m014a0201.asp?insPurchase_req_id=<%=Request.QueryString("insPurchase_req_id")%>&insRqst_requested_id=<%=Request.QueryString("insRqst_requested_id")%>&ClassID="+document.frm0101.SearchResult[document.frm0101.SearchResult.selectedIndex].value+"&ClassName="+document.frm0101.SearchResult.options[document.frm0101.SearchResult.selectedIndex].text;	
	<% 
	} else { 
	%>
			top.opener.document.frm0201.action = "m014e0201.asp?insPurchase_req_id=<%=Request.QueryString("insPurchase_req_id")%>&insRqst_requested_id=<%=Request.QueryString("insRqst_requested_id")%>&ClassID="+document.frm0101.SearchResult[document.frm0101.SearchResult.selectedIndex].value+"&ClassName="+document.frm0101.SearchResult.options[document.frm0101.SearchResult.selectedIndex].text;	
	<% 
	} 
	%>
