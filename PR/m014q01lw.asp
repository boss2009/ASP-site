...
%>	
	<a href="m014q02lw.asp?ClassID=<%=rsAbstractClass.Fields.Item("insEquip_Class_id").Value%>&insPurchase_req_id=<%=Request.QueryString("insPurchase_req_id")%>&insRqst_requested_id=<%=Request.QueryString("insRqst_requested_id")%>"><img src="../i/collapse.gif" align="absmiddle" ALT="Expand Abstract Class <%=rsAbstractClass.Fields.Item("chvName").Value%>"></a><%=rsAbstractClass.Fields.Item("chvName").Value%><br>
<%
