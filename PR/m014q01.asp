...
<table cellspacing="1">
    <tr> 
		<td align="left" width="440">Displaying Records <b><%=(rsPurchase_first)%></b> to <b><%=(rsPurchase_last)%></b> of <b><%=(rsPurchase_total)%></b></td>
...
%>
    <tr> 
        ...
        <td nowrap align="left"><%=(rsPurchase.Fields.Item("chvVendor").Value)%>&nbsp;</td>		
        <td nowrap><%=(rsPurchase.Fields.Item("chvRequest_Type").Value)%>&nbsp;</td>
        <td nowrap align="center"><%=(rsPurchase.Fields.Item("chvPurchase_Status").Value)%>&nbsp;</td>
        <td nowrap align="center"><%=FilterDate(rsPurchase.Fields.Item("dtsDate_Ordered").Value)%>&nbsp;</td>
        <td nowrap align="center"><%=FilterDate(rsPurchase.Fields.Item("dtsDate_Received").Value)%>&nbsp;</td>
        <td nowrap align="center"><%=(rsPurchase.Fields.Item("bitInv_on_bk_order").Value)%>&nbsp;</td>
    </tr>
<%
	Repeat1__index++;
	rsPurchase.MoveNext();
