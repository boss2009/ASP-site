...
rsPerformance.Source = "{call dbo.cp_PR_Pfrm_Rpt("+Request.Form("Vendor")+",0,'"+Request.Form("StartDate")+"','"+Request.Form("EndDate")+"',0,0,0)}";
...
<html>
<head>
	<title>Delivery Performance-Vendor: <%=Request.Form("VendorName")%></title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
	<link rel="stylesheet" href="../css/MyStyle.css" type="text/css">
</head>
<body>
<h3>Delivery Performance - <%=Request.Form("VendorName")%></h3>
...
<table cellpadding="2" cellspacing="1" class="Mtable">
	<tr> 
		...
		<th nowrap class="headrow" align="left">Days Taken</th>	  
		<th nowrap class="headrow" align="left">B/O Received Date</th>	  
		<th nowrap class="headrow" align="left">B/O Equip./Days Taken</th>
    </tr>
<% 
var total1 = 0;
var total2 = 0;	
...
%>
Average # of Days Per Product = <%=(total1/rsPerformance_total)%>(not including B/O Equipment)<br><br>
Average # of Days Per Product = <%=(total2/rsPerformance_total)%>(including B/O Equipment)
<%
}
%>
</body>
