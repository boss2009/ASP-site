...
rsPerformance.Source = "{call dbo.cp_PR_Pfrm_Rpt(0,"+Request.QueryString("ClassSearchID")+",'"+Request.QueryString("StartDate")+"','"+Request.QueryString("EndDate")+"',0,1,0)}";
...
rsPerformanceSummary.Source = "{call dbo.cp_PR_Pfrm_Rpt(0,"+Request.QueryString("ClassSearchID")+",'"+Request.QueryString("StartDate")+"','"+Request.QueryString("EndDate")+"',0,2,0)}";
...
<html>
<head>
	<title>Delivery Performance - Product: <%=Request.QueryString("ClassSearchText")%></title>
</head>
<body>
<table>
	<tr>
		<td colspan="7">Delivery Performance - <%=Request.QueryString("ClassSearchText")%></td>
	</tr>
	<tr>
    ...
    <tr> 
		...
		<th align="left">Days Taken</th>	  
		<th align="left">Backorder Received Date</th>	  
		<th align="left">Backorder Days Taken</th>
    </tr>
<% 
var total1 = 0;
var total2 = 0;	
...
%>
  	<tr>
		<td colspan="7"><%=rsPerformanceSummary.Fields.Item("chvName").Value%>: Average # of Days = <%=DaysTaken/PRCount%> (not including B/O Equipment)</td>
	</tr>
	<tr>
		<td colspan="7"><%=rsPerformanceSummary.Fields.Item("chvName").Value%>: Average # of Days = <%=(DaysTaken+BOTaken)/PRCount%> (including B/O Equipment)</td>
	</tr>
	<tr>
		<td colspan="7"></td>
	</tr>
