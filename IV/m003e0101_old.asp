...
<!--
// + Nov.08.2005
			<input type="text" name="DateReceived" value="<%=((UseInventoryDate)?FilterDate(rsInventory.Fields.Item("dtsIvtry_Rec_Date").Value):FilterDate(rsInventory.Fields.Item("dtsRec_Date").Value))%>" size="11" maxlength=10 tabindex="17" readonly style="border: none" onChange="FormatDate(this)">
-->
			<input type="text" name="DateReceived" value="<%=((UseInventoryDate)?FilterDate(rsInventory.Fields.Item("dtsIvtry_Rec_Date").Value):FilterDate(rsInventory.Fields.Item("dtsRec_Date").Value))%>" size="11" maxlength=10 tabindex="17" readonly style="border: none" onChange="FormatDate(this)">
