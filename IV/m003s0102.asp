...
<html>
<head>
	<title>Inventory - Advanced Search</title>
	...
	rsInstitution.Source = "select * from dbo.tbl_school where insschool_type_id in (4,5,7,8)";
	...
	function CnstrFltr(output) {	
		...
		if (output==1) {
			...
			var ExcelSearch = window.open("m003q01excel.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter);
		}
	}
...
<h3>Inventory - Advanced Search</h3>
<hr>
