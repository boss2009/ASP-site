...
rsInventory.Source = "{call dbo.cp_Get_EqCls_Inventory_07("+Request.QueryString("ClassID")+",'"+Request.QueryString("ClassType")+"',"+Request.QueryString("inspSrtBy")+","+Request.QueryString("inspSrtOrd")+",'"+String(Request.QueryString("chvFilter")).replace(/'/g, "''")+"',0)}";
...
%>
	<tr> 
        <td valign="top" align="left"><a href="javascript: openWindow('m003FS3.asp?intEquip_Set_id=<%=(rsInventory.Fields.Item("intEquip_Set_id").Value)%>&intBar_Code_no=<%=rsInventory.Fields.Item("intBar_Code_no").Value%>','w003E01');"><%=Truncate(rsInventory.Fields.Item("chvInventory_Name").Value,40)%></a>&nbsp;</td>
        <td valign="top" align="center" nowrap><%=ZeroPadFormat(rsInventory.Fields.Item("intBar_Code_no").Value,8)%>&nbsp;</td>
