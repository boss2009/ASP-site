...
%>	
	<a href="m003q02lw.asp?ClassID=<%=rsAbstractClass.Fields.Item("insEquip_Class_id").Value%>"><img src="../i/collapse.gif" align="absmiddle" ALT="Expand Abstract Class <%=rsAbstractClass.Fields.Item("chvName").Value%>"></a><%=rsAbstractClass.Fields.Item("chvName").Value%><br>
<%
