...
<table width="725" border="0" class="HdrReg">
  ...
  <tr> 
    <td colspan="3"> 
      <table width="725" border="0">
        <tr> 
          <td width="701" class="HdrReg">As Manager of the Adult Services Project, 
            I am writing you with regards to your request to extend <%=(rsClient.Fields.Item("chvName").Value)%>'s equipment loan. We are pleased to inform you that Adult 
            Services Project is able to extend the loan for:</td>
          <td width="14">&nbsp;</td>
        </tr>
      </table>
    </td>
      ...
      <table width="709" border="0">
        <tr> 
          <td width="703" class="HdrReg">After this period, we will require written 
            confirmation that <%=(rsClient.Fields.Item("chvName").Value)%> meets ASP's eligibility criteria. A new CIP may also 
  ...
  <tr> 
    <td colspan="3">If you have any further questions or concerns regarding this 
      decision, please feel free to contact me at 264-8295</td>
  </tr>
  <tr> 
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr> 
    <td colspan="3">Gladys Loewen,</td>
  </tr>
  <tr> 
    <td colspan="3">Program Manager</td>
  </tr>
  <tr> 
    <td colspan="3">&nbsp;</td>
  </tr>
