...
<table width="570" border="0" class="HdrReg">
  ...
  <tr> 
    <td colspan="5">As Manager of the Assistive Technology - British Columbia, I am writing you 
      with regards to <%=(rsClient.Fields.Item("chvName").Value)%> 's referral application received by this office. We are pleased 
      to inform you that <%=(rsClient.Fields.Item("chvFst_Name").Value)%> has been accepted for services through the Assistive Technology - British Columbia.</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr> 
    <td width="25">&nbsp;</td>
  ...
  <tr> 
    <td colspan="5">If the student agrees, please have the student sign the attached 
      waiver form (see attached) and return to Assistive Technology - British Columbia for implementation 
  ...
  <tr> 
    <td colspan="5">This funding is to allow <%=(rsClient.Fields.Item("chvFst_Name").Value)%> to purchase equipment during current study period for the CSG 
      program year August 01, 2001 and ending July 31, 2002</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr> 
    <td width="25">&nbsp;</td>
  ...
  <tr> 
    <td colspan="5">ASP personnel will then contact you to make arrangements for 
  ...
  <tr> 
    <td colspan="5">If you have any further questions or concerns regarding this 
      decision, please feel free to contact me at (604) 264-8295.</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr> 
    <td width="25">&nbsp;</td>
  ...
  <tr> 
    <td colspan="5">Thank you for this referral and we hope that the Assistive Technology - British Columbia can be of assistance to you in the future</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr> 
    <td width="25">&nbsp;</td>
  ...
  <tr> 
    <td colspan="5">Gladys Loewen</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr> 
    <td colspan="5">Program Manager</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr> 
    <td width="25">&nbsp;</td>
  ...
  <tr> 
    <td width="25">&nbsp;</td>
    <td colspan="4"> Shirley Marshall, A/Coordinator, Special Programs, AVED, 
      Student Services</td>
    <td width="22">&nbsp;</td>
  </tr>
  <tr>
