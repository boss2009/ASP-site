  ...
  <tr> 
    <td colspan="3"> 
      <div align="left"><%=(rsClient.Fields.Item("chvName").Value)%> is in default of the established equipment purchase plan 
        dated [--date--] to purchase the loaned equipment from Assistive Technology - British Columbia. I have made numerous phone calls and attempts to get the payment 
        plan on track. As a consequence, I am requesting that this letter be placed 
        in the VRS file for <%=(rsClient.Fields.Item("chvName").Value)%>, as a reminder that <%=(rsClient.Fields.Item("chvName").Value)%> is not in good standing with VRS and ASP</div>
    </td>
    <td width="49">&nbsp;</td>
  </tr>
  <tr> 
