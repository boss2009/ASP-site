...
<table width="725" border="0" class="HdrReg">
  ...
  <tr> 
    <td colspan="3"> 
      <div align="left"></div>
      Further to our letter dated ______________ regarding <%=(rsClient.Fields.Item("chvName").Value)%>s eligibility status with the Assistive Technology - British Columbia. We have 
      received the outstanding equipment that was on loan to <%=(rsClient.Fields.Item("chvFst_Name").Value)%> on _______________ and have returned it to the Adult Services 
      Loan Bank</td>
    <td width="30">&nbsp;</td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td colspan="3">I am requesting that this letter be placed in both the VRS 
      file and the [Post-Secondary] file for <%=(rsClient.Fields.Item("chvFst_Name").Value)%> who is now in good standing with the Assistive Technology - British Columbia</td>
    <td width="30">&nbsp;</td>
  </tr>
  <tr> 
    <td colspan="4">&nbsp;</td>
