...
%>
  ...
  <tr> 
    <td colspan="4"> 
      <table width="653" border="0">
        <tr> 
          <td width="614" class="HdrReg"> through the PILAT program has expired. 
            The PILAT Loan Agreement indicates (date) as the return date. Please 
            contact our office by calling (604) 264-8295 to arrange for the return 
            of the hardware/software to the Assistive Technology - British Columbia</td>
  ...
  <tr>
    <td colspan="4">cc: Donna Woo, Coordinator, AVED, University Colleges and 
