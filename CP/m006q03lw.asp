...
<head>
	...
	function SelectClass(id, name, type){
		if (!top.opener.closed) {	
			top.opener.document.frm06s01.ClassName.value=name;
			top.opener.document.frm06s01.ClassID.value=id;
		}
		top.window.close();
	}	
	</Script>
...
<hr>
<a id=first class="green" href="m006q02lw.asp?ClassID=<%=Request.QueryString("ParentID")%>">.. Back To Parent Class</a><br>
<%
