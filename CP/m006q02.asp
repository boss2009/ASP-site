...
rsCompany.Source = "{call dbo.cp_company3(0,'',0,0,0,0,0,"+rsCompany__inspSrtBy.replace(/'/g, "''")+","+rsCompany__inspSrtOrd.replace(/'/g, "''")+",'"+rsCompany__chvFilter.replace(/'/g, "''")+"',0,'Q',0)}";
