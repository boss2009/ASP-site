...
<html>
<head>
	<title>Organization - Quick Search</title>
	...
	function initscr() {
		...
		document.frm06s01.StringSearchOperand.focus();
	}
	...
	function CnstrFltr(output) {	
		...
		if (chvOptr == "0") {
			...
			if (output==1) {
				document.frm06s01.action = "m006q01.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter ;
			} else {
				document.frm06s01.action = "m006q01excel.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter;
				document.frm06s01.target = "_blank";
...
<body onload="initscr()" >
<form name="frm06s01" method="post" onSubmit="CnstrFltr(1);">
<h3>Organization - Quick Search</h3>
<hr>
