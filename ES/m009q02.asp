<!--------------------------------------------------------------------------
* File Name: m009q02.asp
* Title: Equipment Service - Browse
* Main SP: cp_Get_eqp_srv2
...
%>
      <tr> 
        <td valign="top" align="left" nowrap><a href="javascript: openWindow('../ES/m009FS3.asp?intEquip_Srv_id=<%=(rsEquipmentService.Fields.Item("intEquip_Srv_id").Value)%>','w010E01');"><%=ZeroPadFormat(rsEquipmentService.Fields.Item("intEquip_Set_id").Value, 8)%></a>&nbsp;</td>
