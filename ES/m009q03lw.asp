...
<head>
	...
	function SelectClass(id, name, type){
		if (!top.opener.closed) {	
			top.opener.document.frm09s01.ClassSearchText.value=name;
			top.opener.document.frm09s01.ClassSearchID.value=id;
		}
		top.window.close();
	}	
	</Script>
...
<hr>
	<a id=first class="green" href="m009q02lw.asp?ClassID=<%=Request.QueryString("ParentID")%>">.. Back To Parent Class</a><br>
	<%
