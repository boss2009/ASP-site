...
var intShip_dtl_id = (((!rsBuyout.EOF) && (rsBuyout.Fields.Item("intShip_dtl_id").Value != null))?rsBuyout.Fields.Item("intShip_dtl_id").Value:0);
...
if (String(Request("MM_action")) == "update") {
	...
	rsShippingAddress.Source = "{call dbo.cp_buyout_ship_address("+Request.Form("MM_recordId")+",0,'"+Request.Form("AddressType")+"','"+UserFirstName+"','"+UserLastName+"','"+ContactFirstName+"','"+ContactLastName+"',"+Request.Form("AddressID")+",'"+StreetAddress+"','"+Trim(City)+"',"+Request.Form("ProvinceState")+",'"+Trim(Request.Form("PostalCode"))+"',"+Request.Form("PrimaryPhoneType")+",'"+Trim(Request.Form("PrimaryPhoneAreaCode"))+"','"+Trim(Request.Form("PrimaryPhoneNumber"))+"','"+Trim(Request.Form("PrimaryPhoneExtension"))+"',"+Request.Form("SecondaryPhoneType")+",'"+Request.Form("SecondaryPhoneAreaCode")+"','"+Trim(Request.Form("SecondaryPhoneNumber"))+"','"+Trim(Request.Form("SecondaryPhoneExtension"))+"',0,'','','','"+Request.Form("Email")+"','',0,'E',0)}";
...
if (String(Request("MM_action")) == "insert") {
	...
	var rsShippingAddress = Server.CreateObject("ADODB.Recordset");
	rsShippingAddress.ActiveConnection = MM_cnnASP02_STRING;
	rsShippingAddress.Source = "{call dbo.cp_buyout_ship_address("+Request.Form("MM_recordId")+",0,'"+Request.Form("AddressType")+"','"+UserFirstName+"','"+UserLastName+"','"+ContactFirstName+"','"+ContactLastName+"',0,'"+StreetAddress+"','"+Trim(City)+"',"+Request.Form("ProvinceState")+",'"+Trim(Request.Form("PostalCode"))+"',"+Request.Form("PrimaryPhoneType")+",'"+Trim(Request.Form("PrimaryPhoneAreaCode"))+"','"+Trim(Request.Form("PrimaryPhoneNumber"))+"','"+Trim(Request.Form("PrimaryPhoneExtension"))+"',"+Request.Form("SecondaryPhoneType")+",'"+Request.Form("SecondaryPhoneAreaCode")+"','"+Trim(Request.Form("SecondaryPhoneNumber"))+"','"+Trim(Request.Form("SecondaryPhoneExtension"))+"',0,'','','','"+Request.Form("Email")+"','',0,'A',0)}";
	rsShippingAddress.CursorType = 0;
	rsShippingAddress.CursorLocation = 2;
	rsShippingAddress.LockType = 3;
	rsShippingAddress.Open();
...
if (String(rsBuyout.Fields.Item("insEq_user_type").Value)=="3") {
	...
	CheckHomeAddress.Parameters.Append(CheckHomeAddress.CreateParameter("@insUser_id", 3, 1,10000,rsBuyout.Fields.Item("intEq_user_id").Value));
	...
	rsHomeAddress.Source = "{call dbo.cp_eqpsrv_homeaddrs_drv("+rsBuyout.Fields.Item("intEq_user_id").Value+",0)}";
	...
	rsSchoolAddress.Source = "{call dbo.cp_eqpsrv_schaddrs_drv("+rsBuyout.Fields.Item("intEq_user_id").Value+",0)}";
	...
	rsWorkAddress.Source = "{call dbo.cp_eqpsrv_emplyadrs_drv("+rsBuyout.Fields.Item("intEq_user_id").Value+",0)}";
	rsWorkAddress.CursorType = 0;
	rsWorkAddress.CursorLocation = 2;
	rsWorkAddress.LockType = 3;
	rsWorkAddress.Open();
} else if (String(rsBuyout.Fields.Item("insEq_user_type").Value)=="4") {
	var rsInstitutionAddress = Server.CreateObject("ADODB.Recordset");
	rsInstitutionAddress.ActiveConnection = MM_cnnASP02_STRING;
	rsInstitutionAddress.Source = "{call dbo.cp_school_address("+rsBuyout.Fields.Item("intEq_user_id").Value+",0,'','',0,'',0,'','','',0,'','','',0,'','','','','',1,'Q',0)}";
	...
	if (window.event.ctrlKey) {
		switch (window.event.keyCode) {
			...
			break;
		   	case 76 :
				//alert("L");
				window.location.href='m010e0501.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>';
			break;
		}
	}
	</script>	
...
%>	
	...
	function ChangeAddressType(){
		...
		switch (document.frm0502.AddressType.value) {
			//Home
			case "1":
				document.frm0502.StreetAddress.value=HomeArray[0];
				document.frm0502.City.value=HomeArray[1];
				document.frm0502.ProvinceState.value=HomeArray[2];								
				document.frm0502.Country.value=HomeArray[3];
				document.frm0502.PostalCode.value=HomeArray[4];								
				document.frm0502.PrimaryPhoneType.value=HomeArray[5];
				document.frm0502.PrimaryPhoneAreaCode.value=HomeArray[6];
				document.frm0502.PrimaryPhoneNumber.value=HomeArray[7];
				document.frm0502.PrimaryPhoneExtension.value=HomeArray[8];
				document.frm0502.SecondaryPhoneType.value=HomeArray[9];
				document.frm0502.SecondaryPhoneAreaCode.value=HomeArray[10];
				document.frm0502.SecondaryPhoneNumber.value=HomeArray[11];
				document.frm0502.SecondaryPhoneExtension.value=HomeArray[12];
			break;
			//PostSec
			case "2":
				document.frm0502.StreetAddress.value=SchoolArray[0];
				document.frm0502.City.value=SchoolArray[1];
				document.frm0502.ProvinceState.value=SchoolArray[2];		
				document.frm0502.Country.value=SchoolArray[3];
				document.frm0502.PostalCode.value=SchoolArray[4];								
				document.frm0502.PrimaryPhoneType.value=SchoolArray[5];
				document.frm0502.PrimaryPhoneAreaCode.value=SchoolArray[6];
				document.frm0502.PrimaryPhoneNumber.value=SchoolArray[7];
				document.frm0502.PrimaryPhoneExtension.value=SchoolArray[8];
				document.frm0502.SecondaryPhoneType.value=SchoolArray[9];
				document.frm0502.SecondaryPhoneAreaCode.value=SchoolArray[10];
				document.frm0502.SecondaryPhoneNumber.value=SchoolArray[11];
				document.frm0502.SecondaryPhoneExtension.value=SchoolArray[12];
			break;
			//Work
			case "3":
				document.frm0502.StreetAddress.value=WorkArray[0];
				document.frm0502.City.value=WorkArray[1];
				document.frm0502.ProvinceState.value=WorkArray[2];	
				document.frm0502.Country.value=WorkArray[3];
				document.frm0502.PostalCode.value=WorkArray[4];								
				document.frm0502.PrimaryPhoneType.value=WorkArray[5];
				document.frm0502.PrimaryPhoneAreaCode.value=WorkArray[6];
				document.frm0502.PrimaryPhoneNumber.value=WorkArray[7];
				document.frm0502.PrimaryPhoneExtension.value=WorkArray[8];
				document.frm0502.SecondaryPhoneType.value=WorkArray[9];
				document.frm0502.SecondaryPhoneAreaCode.value=WorkArray[10];
				document.frm0502.SecondaryPhoneNumber.value=WorkArray[11];
				document.frm0502.SecondaryPhoneExtension.value=WorkArray[12];
			break;
			//Other
			case "0":
				document.frm0502.StreetAddress.value="";
				document.frm0502.City.value="";
				document.frm0502.ProvinceState.value=101;								
				document.frm0502.Country.value="";
				document.frm0502.PostalCode.value="";								
				document.frm0502.PrimaryPhoneType.value=0;
				document.frm0502.PrimaryPhoneAreaCode.value="";
				document.frm0502.PrimaryPhoneNumber.value="";
				document.frm0502.PrimaryPhoneExtension.value="";
				document.frm0502.SecondaryPhoneType.value=0;
				document.frm0502.SecondaryPhoneAreaCode.value="";
				document.frm0502.SecondaryPhoneNumber.value="";
				document.frm0502.SecondaryPhoneExtension.value="";
			break;	
		}	
	}
	...
	if (!rsShippingAddress.EOF) {
	%>
		document.frm0502.AddressType.focus();
	<%
		if (IsNew) {
	%>		
		ChangeAddressType();	
	...
	function Save(){
		if (!CheckPostalCode(document.frm0502.PostalCode.value)){
			alert("Invalid Postal Code.");
			document.frm0502.PostalCode.focus();
			return ;
		}
		var tempPC = document.frm0502.PostalCode.value;
		tempPC = tempPC.toUpperCase();
		document.frm0502.PostalCode.value = tempPC;				
...
<table cellpadding="1" cellspacing="1">
	<tr>
		...
		<td><select name="AddressType" tabindex="1" onChange="ChangeAddressType();" accesskey="F">
		...
		<td>Facility:</td>
		<td><input type="text" name="Facility" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvFacility").Value:"")%>" readonly tabindex="2"></td>		
	</tr>
	<tr>
		<td nowrap>User First Name:</td>
		<td><input type="text" name="UserFirstName" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvUsr_Fstname").Value:"")%>" tabindex="3"></td>
		<td nowrap>User Last Name:</td>
		<td><input type="text" name="UserLastName" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvUsr_Lstname").Value:"")%>" tabindex="4"></td>
	</tr>
	<tr>
		<td nowrap>Contact First Name:</td>
		<td><input type="text" name="ContactFirstName" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvCo_Fstname").Value:"")%>" tabindex="5"></td>
		<td nowrap>Contact Last Name:</td>
		<td><input type="text" name="ContactLastName" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvCo_Lstname").Value:"")%>" tabindex="6"></td>
	</tr>
	<tr> 
		<td nowrap valign="top">Street Address:</td>
		<td colspan="3"><textarea name="StreetAddress" cols="30" rows="3" tabindex="7"><%=((!IsNew)?rsShippingAddress.Fields.Item("chvAddress").Value:"")%></textarea></td>
	</tr>
	<tr> 
		<td nowrap>City:</td>
		<td><input type="text" name="City" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvCity").Value:"")%>" maxlength="50" tabindex="8"></td>
		...
		<td align="left">
			...
			%>
				<option value="<%=(rsProvince.Fields.Item("intprvst_id").Value)%>" <%if (!IsNew) Response.Write(((rsShippingAddress.Fields.Item("intprvst_id").Value==rsProvince.Fields.Item("intprvst_id").Value)?"SELECTED":""))%>><%=(rsProvince.Fields.Item("chrprvst_abbv").Value)%></option>
			<%
				rsProvince.MoveNext();
			}
			%>
	...
	<tr>
		...
		<td><input type="text" name="Country" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvcntry_name").Value:"")%>" tabindex="10" readonly></td>
		<td nowrap>Postal Code:</td>
		<td align="left"><input type="text" name="PostalCode" value="<%=((!IsNew)?FormatPostalCode(rsShippingAddress.Fields.Item("chvPostal_zip").Value):"")%>" tabindex="11" size="10" maxlength="7" onChange="FormatPostalCode(this);"></td>
    </tr>
    <tr> 
    ...
    <tr> 
		...
		<td nowrap colspan="3">
			...
			while (!rsAreaCode.EOF) {			
			%>
				<option value="<%=rsAreaCode.Fields.Item("chvAC_num").Value%>" <%if (!IsNew) Response.Write(((rsAreaCode.Fields.Item("chvAC_num").Value==rsShippingAddress.Fields.Item("chvPhone2_Arcd").Value)?"SELECTED":""))%>><%=rsAreaCode.Fields.Item("chvAC_num").Value%>
			<%
				rsAreaCode.MoveNext();
			}
			%>			
...
<table cellpadding="1" cellspacing="1">
	<tr> 
		...
		<td><input type="button" value="Print Shipping Label" tabindex="21" onClick="window.open('m010e0504.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>')" class="btnstyle"></td>
		<td><input type="button" value="Close" tabindex="22" onClick="window.location.href='m010e0501.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>';" class="btnstyle"></td>
    </tr>
</table>
