<!--------------------------------------------------------------------------
* File Name: m010e0504.asp
* Title: Buyout Shipping Label
...
rsRecipient.Source = "{call dbo.cp_buyout_ship_address(" & intShip_dtl_id & ",0,'','','','','',0,'','',0,'',0,'','','',0,'','','',0,'','','','','',0,'Q',0)}"
...
RecipientAddress = RecipientAddress & rsRecipient.Fields.Item("chvCity").Value & ", " & rsRecipient.Fields.Item("chrprvst_abbv").Value & Chr(13) & rsRecipient.Fields.Item("chvPostal_zip").Value & Chr(13)
...
'
mySLfdf.fdfSetFile "http://" & server_address & "/BO/Shipping_Label.pdf"
...
Dim filestamp1
filestamp1 = FileStamp(Request("intBuyout_req_id"))
if Request.ServerVariables("LOCAL_ADDR")= "192.168.2.192" Then
...
<html>
<head>
	<title>Buyout Shipping Label</title>
