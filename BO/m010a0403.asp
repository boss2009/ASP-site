...
if (String(Request.Form("MM_Insert"))=="true") {
	...
	rsNotes.Source = "{call dbo.cp_buyout_sold_notes("+Request.QueryString("intBuyout_req_id")+",0,'"+Notes+"',"+ Session("insStaff_id")+",'6',0,'A',0)}";
...
<html>
<head>
	<title>New Equipment Sold Notes</title>
...
<h5>New Equipment Sold Notes</h5>
<hr>
