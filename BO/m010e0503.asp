...
if ((!rsBuyout.EOF) && (rsBuyout.Fields.Item("intShip_dtl_id").Value != null)) intShip_dtl_id = rsBuyout.Fields.Item("intShip_dtl_id").Value;
...
rsShippingSchedule.Source = "{call dbo.cp_buyout_ship_schedule("+intShip_dtl_id+",0,0,0,'','','','Q',0)}";
...
<table cellpadding="1" cellspacing="1">
	<tr>
		...
		<td>
			<input type="text" name="ScheduledArrivalDate" value="<%=FilterDate(rsMethod.Fields.Item("dtsSch_Arv_date").Value)%>" size="11" maxlength="10" tabindex="1" style="border: none" readonly accesskey="F" onChange="FormatDate(this)">
...
<table cellpadding="1" cellspacing="1">
	<tr> 
		...
		<td><input type="button" value="Close" tabindex="6" onClick="window.location.href='m010e0501.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>';" class="btnstyle"></td>
    </tr>
</table>
