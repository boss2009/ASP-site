...
<head>
	...
	function CnstrFltr() {
		...
		if (chvOptr == "0") {
			...
			stgPgQuery += "m010p0202.asp?Search=true&inspSrtBy=1&inspSrtOrd=0&chvFilter=" + stgFilter ;
		}
	...
	function SelectClient(){
		...
		opener.document.frm0101.BuyerType.value="3";
		opener.document.frm0101.ClientBuyerID.value=document.frm10p02.SearchResult[document.frm10p02.SearchResult.selectedIndex].value;
		opener.document.frm0101.ClientBuyerName.value=document.frm10p02.SearchResult.options[document.frm10p02.SearchResult.selectedIndex].text;
		self.close();
	}
	</script>
</head>
...
<table cellpadding="1" cellspacing="1">
	<tr> 
		...
		<td nowrap><DIV ID="oStg1" STYLE="visibility:visible">
			<input type="text" name="StringSearchTextBoxOne" size="10" tabindex="4">
		</DIV></td>
		<td nowrap><DIV ID="oStg2" STYLE="visibility:hidden">
			<span style="font-size: 7pt">(mm/dd/yyyy)</span>		
			<input type="text" name="StringSearchTextBoxTwo" size="10" tabindex="5" DISABLED accesskey="L">
			<span style="font-size: 7pt">(mm/dd/yyyy)</span>
		</DIV></td>
	</tr>
	<tr>
