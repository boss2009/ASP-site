<!--------------------------------------------------------------------------
* File Name: m010q01.asp
* Title: Buyout - Browse
* Main SP: cp_buyout_request3
...
rsBuyout.Source = "{call dbo.cp_buyout_request3(0,0,0,'',0,'',0,0,0,0,0,'Q',0)}";
...
<table cellspacing="1">
    <tr> 
		<td align="left" width="430">Displaying Records <b><%=(rsBuyout_first)%></b> to <b><%=(rsBuyout_last)%></b> of <b><%=(rsBuyout_total)%></b></td>
  ...
  <div class="BrowsePanel" style="height: 295px; width: 100%"> 
    <table cellpadding="2" cellspacing="1">
      <tr> 
        ...
        <th nowrap class="headrow" align="left">Date Approved</th>
...
%>
      <tr> 
        ...
        <td nowrap align="center"><%=FilterDate(rsBuyout.Fields.Item("dtsRequest_date").Value)%>&nbsp;</td>
        <td nowrap align="center"><%=FilterDate(rsBuyout.Fields.Item("dtsApprvd_Date").Value)%>&nbsp;</td>
