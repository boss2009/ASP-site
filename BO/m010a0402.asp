...
if (String(Request.Form("MM_Insert"))=="true") {
	...
	rsNotes.Source = "{call dbo.cp_buyout_request_notes("+Request.QueryString("intBuyout_req_id")+",0,'"+Notes+"',"+ Session("insStaff_id")+",'5',0,'A',0)}";
...
<html>
<head>
	<title>New Equipment Requested Notes</title>
...
<h5>New Equipment Requested Notes</h5>
<hr>
