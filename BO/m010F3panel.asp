...
<html>
<head>
	<title>Buyout Request Panel</title>
...
%>
    <tr> 
		<td height="18px" class="MenuItem" align="center"><a href="<%=(rsFunction.Fields.Item("filename").Value)%>?intBuyout_Req_id=<%=Request.QueryString("intBuyout_Req_id")%>" target="BodyFrame"><%=(rsFunction.Fields.Item("name").Value)%></a></td>
    </tr>
<%
	rsFunction.MoveNext();
}
%>
	<tr>
		<td height="18px" class="MenuItem" align="center"><a href="m010q1001.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>" target="BodyFrame">Correspondence</a></td>	
	</tr>
<!--	
	<tr>
		<td height="18px" class="MenuItem" align="center"><a href="m010q0301b.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>" target="BodyFrame">Test Equip Sold.</a></td>	
	</tr>
-->
	<tr>
	...
	<tr> 
		<td height="18px" class="MenuItem" align="center"><a href="javascript: openWindow('m010a01j.asp?intBuyout_Req_id=<%=Request.QueryString("intBuyout_Req_id")%>','wj0101');" accesskey=D>Copy to DeskTop</a></td>
	</tr>	
</table>
</body>
</html>
