...
<head>
	...
	function SelectClass(){
		...
		if (!top.opener.closed) {		
			top.opener.document.frm10s01.ClassSearchText.value=document.frm0101.SearchResult.options[document.frm0101.SearchResult.selectedIndex].text;
			top.opener.document.frm10s01.ClassSearchID.value=document.frm0101.SearchResult[document.frm0101.SearchResult.selectedIndex].value;
		}
		top.window.close();
	}
