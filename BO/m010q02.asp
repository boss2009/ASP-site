<!--------------------------------------------------------------------------
* File Name: m010q02.asp
* Title: Buyout - Browse
* Main SP: cp_search_buyout_request
...
rsBuyout.Source = "{call dbo.cp_search_buyout_request("+rsBuyout__inspSrtBy+","+rsBuyout__inspSrtOrd+",'"+rsBuyout__chvFilter.replace(/'/g, "''")+"',0)}";
...
<div class="BrowsePanel" style="height: 320px; width: 100%"> 
    <table cellpadding="2" cellspacing="1">
      <tr> 
        ...
        <!--<th nowrap class="headrow" align="left">Start Date</th>-->
...
%>
      <tr> 
        ...
        <!--<td nowrap align="center"><%=FilterDate(rsBuyout.Fields.Item("dtsStart_date").Value)%>&nbsp;</td>-->
