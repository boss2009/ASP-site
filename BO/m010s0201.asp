...
<html>
<head>
	<title>Buyout - Advanced Search</title>
	...
	function CnstrFltr(output){
		...
		if (output==1) {
			document.frm10s01.action = "m010q03.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter ;		
			document.frm10s01.submit() ; 		
		} else {
			var ExcelSearch = window.open("m010q03excel.asp?inspSrtBy="+inspSrtBy+"&inspSrtOrd="+inspSrtOrd+"&chvFilter=" + stgFilter);
		}
	}
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td><select name="AndOr" tabindex="15">
