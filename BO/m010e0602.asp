...
if (!rsBuyout.EOF) {
	if (rsBuyout.Fields.Item("intBOShip_dtl_id").Value != null) intBOShip_dtl_id = Number(rsBuyout.Fields.Item("intBOShip_dtl_id").Value);
}			
...
rsShippingAddress.Source = "{call dbo.cp_buyout_ship_address("+intBOShip_dtl_id+",0,'','','','','',0,'','',0,'',0,'','','',0,'','','',0,'','','','','',0,'Q',0)}";
...
if (rsBuyout.Fields.Item("insEq_user_type").Value=="3") {
	...
	rsWorkAddress.Open();
} else if (rsBuyout.Fields.Item("insEq_user_type").Value=="4") {
...
%>	
	function ChangeAddressType(){
		switch (document.frm0602.AddressType.value) {
			//Home
			case "1":
				document.frm0602.StreetAddress.value=HomeArray[0];
				document.frm0602.City.value=HomeArray[1];
				document.frm0602.ProvinceState.value=HomeArray[2];								
				document.frm0602.Country.value=HomeArray[3];
				document.frm0602.PostalCode.value=HomeArray[4];								
				document.frm0602.PrimaryPhoneType.value=HomeArray[5];
				document.frm0602.PrimaryPhoneAreaCode.value=HomeArray[6];
				document.frm0602.PrimaryPhoneNumber.value=HomeArray[7];
				document.frm0602.PrimaryPhoneExtension.value=HomeArray[8];
				document.frm0602.SecondaryPhoneType.value=HomeArray[9];
				document.frm0602.SecondaryPhoneAreaCode.value=HomeArray[10];
				document.frm0602.SecondaryPhoneNumber.value=HomeArray[11];
				document.frm0602.SecondaryPhoneExtension.value=HomeArray[12];
			break;
			//PostSec
			case "2":
				document.frm0602.StreetAddress.value=SchoolArray[0];
				document.frm0602.City.value=SchoolArray[1];
				document.frm0602.ProvinceState.value=SchoolArray[2];		
				document.frm0602.Country.value=SchoolArray[3];
				document.frm0602.PostalCode.value=SchoolArray[4];								
				document.frm0602.PrimaryPhoneType.value=SchoolArray[5];
				document.frm0602.PrimaryPhoneAreaCode.value=SchoolArray[6];
				document.frm0602.PrimaryPhoneNumber.value=SchoolArray[7];
				document.frm0602.PrimaryPhoneExtension.value=SchoolArray[8];
				document.frm0602.SecondaryPhoneType.value=SchoolArray[9];
				document.frm0602.SecondaryPhoneAreaCode.value=SchoolArray[10];
				document.frm0602.SecondaryPhoneNumber.value=SchoolArray[11];
				document.frm0602.SecondaryPhoneExtension.value=SchoolArray[12];
			break;
			//Work
			case "3":
				document.frm0602.StreetAddress.value=WorkArray[0];
				document.frm0602.City.value=WorkArray[1];
				document.frm0602.ProvinceState.value=WorkArray[2];	
				document.frm0602.Country.value=WorkArray[3];
				document.frm0602.PostalCode.value=WorkArray[4];								
				document.frm0602.PrimaryPhoneType.value=WorkArray[5];
				document.frm0602.PrimaryPhoneAreaCode.value=WorkArray[6];
				document.frm0602.PrimaryPhoneNumber.value=WorkArray[7];
				document.frm0602.PrimaryPhoneExtension.value=WorkArray[8];
				document.frm0602.SecondaryPhoneType.value=WorkArray[9];
				document.frm0602.SecondaryPhoneAreaCode.value=WorkArray[10];
				document.frm0602.SecondaryPhoneNumber.value=WorkArray[11];
				document.frm0602.SecondaryPhoneExtension.value=WorkArray[12];
			break;
			//Other
			case "0":
				document.frm0602.StreetAddress.value="";
				document.frm0602.City.value="";
				document.frm0602.ProvinceState.value=101;								
				document.frm0602.Country.value="";
				document.frm0602.PostalCode.value="";								
				document.frm0602.PrimaryPhoneType.value=0;
				document.frm0602.PrimaryPhoneAreaCode.value="";
				document.frm0602.PrimaryPhoneNumber.value="";
				document.frm0602.PrimaryPhoneExtension.value="";
				document.frm0602.SecondaryPhoneType.value=0;
				document.frm0602.SecondaryPhoneAreaCode.value="";
				document.frm0602.SecondaryPhoneNumber.value="";
				document.frm0602.SecondaryPhoneExtension.value="";
			break;	
		}	
	}	
	function Init(){
	...
	if (!rsShippingAddress.EOF) {
	%>
		document.frm0602.AddressType.focus();
	<%
		if (IsNew) {
	%>
		ChangeAddressType();
	...
	function Save(){
		if (!CheckPostalCode(document.frm0602.PostalCode.value)){
			alert("Invalid Postal Code.");
			document.frm0602.PostalCode.focus();
			return ;
		}
		var tempPC = document.frm0602.PostalCode.value;
		tempPC = tempPC.toUpperCase();
		document.frm0602.PostalCode.value = tempPC;						
...
<table cellpadding="1" cellspacing="1">
	...
	<tr>
		...
		<td align="left"><input type="text" name="Country" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvcntry_name").Value:"")%>" tabindex="10" readonly></td>
    ...
    <tr> 
		...
		<td nowrap colspan="3"> 
			...
			<select name="PrimaryPhoneAreaCode" tabindex="13">
				<option value="" <%if (!IsNew) Response.Write(((Trim(rsShippingAddress.Fields.Item("chvPhone1_Arcd").Value)=="")?"SELECTED":""))%>>			
			<%
    ...
    <tr> 
		...
		<td nowrap colspan="3">
			...
			<select name="SecondaryPhoneAreaCode" tabindex="17">
				<option value="" <%if (!IsNew) Response.Write(((Trim(rsShippingAddress.Fields.Item("chvPhone2_Arcd").Value)=="")?"SELECTED":""))%>>
			<%
			while (!rsAreaCode.EOF) {
			%>
...
<table cellpadding="1" cellspacing="1">
	<tr>
		...
		<td><input type="button" value="Close" tabindex="21" onClick="window.location.href='m010e0601.asp?intBuyout_req_id=<%=Request.QueryString("intBuyout_req_id")%>';" class="btnstyle"></td>
    </tr>
</table>
