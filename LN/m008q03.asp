...
%>
      <tr> 
        ...
        <td nowrap align="center"> 
          ...
          <a href="javascript: openWindow('m008pop6.asp?intLoan_Req_id=<%=rsLoan.Fields.Item("intLoan_Req_id").Value%>&insEq_user_type=<%=rsLoan.Fields.Item("insEq_user_type").Value%>&intEq_user_id=<%=rsLoan.Fields.Item("intEq_user_id").Value%>&insInst_User_id=<%=rsLoan.Fields.Item("insInst_User_id").Value%>','wP06');"><img src="../i/summary.gif" alt="Show Referral Type For <%=rsLoan.Fields.Item("chvLoan_name").Value%>"></a> 
          <%}%>
          &nbsp;</td>
      </tr>
      <%
