...
var intShip_dtl_id = (((!rsLoan.EOF) && (rsLoan.Fields.Item("intShip_dtl_id").Value != null))?rsLoan.Fields.Item("intShip_dtl_id").Value:0);
...
if (String(Request("MM_action")) == "update") {
	...
	rsShippingAddress.Source = "{call dbo.cp_loan_ship_address("+Request.Form("MM_recordId")+",0,'"+Request.Form("AddressType")+"','"+UserFirstName+"','"+UserLastName+"','"+ContactFirstName+"','"+ContactLastName+"',"+Request.Form("AddressID")+",'"+StreetAddress+"','"+Trim(City)+"',"+Request.Form("ProvinceState")+",'"+Trim(Request.Form("PostalCode"))+"',"+Request.Form("PrimaryPhoneType")+",'"+Trim(Request.Form("PrimaryPhoneAreaCode"))+"','"+Trim(Request.Form("PrimaryPhoneNumber"))+"','"+Trim(Request.Form("PrimaryPhoneExtension"))+"',"+Request.Form("SecondaryPhoneType")+",'"+Request.Form("SecondaryPhoneAreaCode")+"','"+Trim(Request.Form("SecondaryPhoneNumber"))+"','"+Trim(Request.Form("SecondaryPhoneExtension"))+"',0,'','','','"+Request.Form("Email")+"','',0,'E',0)}";
...
if (String(Request("MM_action")) == "insert") {
	...
	var rsShippingAddress = Server.CreateObject("ADODB.Recordset");
	rsShippingAddress.ActiveConnection = MM_cnnASP02_STRING;
	rsShippingAddress.Source = "{call dbo.cp_loan_ship_address("+Request.Form("MM_recordId")+",0,'"+Request.Form("AddressType")+"','"+UserFirstName+"','"+UserLastName+"','"+ContactFirstName+"','"+ContactLastName+"',0,'"+StreetAddress+"','"+Trim(City)+"',"+Request.Form("ProvinceState")+",'"+Trim(Request.Form("PostalCode"))+"',"+Request.Form("PrimaryPhoneType")+",'"+Trim(Request.Form("PrimaryPhoneAreaCode"))+"','"+Trim(Request.Form("PrimaryPhoneNumber"))+"','"+Trim(Request.Form("PrimaryPhoneExtension"))+"',"+Request.Form("SecondaryPhoneType")+",'"+Request.Form("SecondaryPhoneAreaCode")+"','"+Trim(Request.Form("SecondaryPhoneNumber"))+"','"+Trim(Request.Form("SecondaryPhoneExtension"))+"',0,'','','','"+Request.Form("Email")+"','',0,'A',0)}";
	rsShippingAddress.CursorType = 0;
	rsShippingAddress.CursorLocation = 2;
	rsShippingAddress.LockType = 3;
	rsShippingAddress.Open();
...
<table cellpadding="1" cellspacing="1">
	<tr>
		...
		<td nowrap><input type="text" name="Facility" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvFacility").Value:"")%>" readonly tabindex="2"></td>		
	</tr>
	<tr>
    ...
    <tr>
		...
		<td nowrap colspan="3">
			...
			<input type="text" name="PrimaryPhoneNumber" value="<%=((!IsNew)?FormatPhoneNumberOnly(rsShippingAddress.Fields.Item("chvPhone1_Num").Value):"")%>" size="9" tabindex="14" onKeypress="AllowNumericOnly();" maxlength="8" onChange="FormatPhoneNumberOnly(this)">Ext
			<input type="text" name="PrimaryPhoneExtension" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvPhone1_Ext").Value:"")%>" size="4" tabindex="15" onKeypress="AllowNumericOnly();" >
		</td>
	</tr>
	<tr> 
		...
		<td nowrap colspan="3">
			...
			<input type="text" name="SecondaryPhoneNumber" value="<%=((!IsNew)?FormatPhoneNumberOnly(rsShippingAddress.Fields.Item("chvPhone2_Num").Value):"")%>" size="9" tabindex="18" onKeypress="AllowNumericOnly();" maxlength="8" onChange="FormatPhoneNumberOnly(this)">Ext
			<input type="text" name="SecondaryPhoneExtension" value="<%=((!IsNew)?rsShippingAddress.Fields.Item("chvPhone2_Ext").Value:"")%>" size="4" tabindex="19" onKeypress="AllowNumericOnly();" >
		</td>
    </tr>
</table>
<hr>
<table cellpadding="1" cellspacing="1">
	<tr> 
		...
		<td><input type="button" value="Print Shipping Label" tabindex="21" onClick="window.open('m008e0504.asp?intLoan_Req_id=<%=Request.QueryString("intLoan_req_id")%>')" class="btnstyle"></td>
		<td><input type="button" value="Close" tabindex="22" onClick="window.location.href='m008e0501.asp?intLoan_req_id=<%=Request.QueryString("intLoan_req_id")%>';" class="btnstyle"></td>
    </tr>
</table>
