...
<table cellpadding="1" cellspacing="1">	
	<tr>
		...
		%>
				<option value="<%=(rsSysOptr.Fields.Item("intOptrId").Value)%>"><%=(rsSysOptr.Fields.Item("chvOptrDesc").Value)%></option>
		<% 	
			}
			rsSysOptr.MoveNext(); 
		}
...
<table cellpadding="1" cellspacing="1">
	...
	<tr>
		<td nowrap><input type="button" value="Select Bundle" tabindex="5" onClick="SelectBundle();" class="btnstyle"></td>
	</tr>
</table>
<% 
if (String(Request.QueryString("Search")) == "true") { 
