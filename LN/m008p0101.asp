...
<head>
	...
	function SelectClass(){
		...
		if (!top.opener.closed) {	
			top.opener.document.frm0201.ClassName.value=document.frm0101.SearchResult.options[document.frm0101.SearchResult.selectedIndex].text;
			top.opener.document.frm0201.ClassID.value=document.frm0101.SearchResult[document.frm0101.SearchResult.selectedIndex].value;
			top.opener.document.frm0201.ClassBundle.value=1;		
			if (document.frm0101.ListUnitCost.length > 1) {
				top.opener.document.frm0201.ListUnitCost.value=document.frm0101.ListUnitCost[document.frm0101.SearchResult.selectedIndex].value;
			} else {
				top.opener.document.frm0201.ListUnitCost.value=document.frm0101.ListUnitCost.value;			
			}
