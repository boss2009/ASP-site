...
if (String(Request("MM_Insert")) == "true") {	
	...
	rsInventoryRequest.Source = "{call dbo.cp_eqp_requested(0,"+Request.QueryString("intLoan_req_id")+","+Request.Form("ClassID")+","+Request.Form("ClassBundle")+","+Request.Form("Quantity")+",'"+Comments+"',"+Request.Form("ListUnitCost")+","+IsBackOrdered+",0,'A',0)}";
...
<head>
	...
	function ViewAcc(){
		if (document.frm0201.ClassID.value > 0) temp=window.showModalDialog("m008pop.asp?ClassID="+document.frm0201.ClassID.value,"","dialogHeight: 200px; dialogWidth: 375px; dialogTop: px; dialogLeft: px; edge: Sunken; center: Yes; help: No; resizable: No; status: No;");	
	}
...
<table cellpadding="1" cellspacing="1">
	<tr>
		...
		<td nowrap>
			<input type="text" name="ClassName" size="60" tabindex="1" accesskey="F" readonly>
			<input type="button" name="ListClass" value="List" tabindex="2" onClick="openWindow('m008p01FS.asp?intLoan_req_id=<%=Request.QueryString("intLoan_req_id")%>','');" class="btnstyle">
	...
	<tr>
		...
		<td nowrap>$<input type="text" name="ListUnitCost" size="8" tabindex="4" readonly></td>
	</tr>
	<tr>
		<td nowrap>Quantity:</td>
		<td nowrap><input type="text" name="Quantity" size="6" tabindex="5" value="1" onKeypress="AllowNumericOnly();" onChange="CalculateTotal();"></td>
	</tr>
	<tr>
		<td nowrap>Total:</td>
		<td nowrap><input type="text" name="Total" size="10" tabindex="6" value="0.00" readonly></td>
	</tr>
	<tr>
		<td nowrap>Is Backordered:</td>
		<td nowrap><input type="checkbox" name="IsBackOrdered" tabindex="7" class="chkstyle"></td>
	</tr>
	<tr>
		<td nowrap valign="top">Comments:</td>
		<td nowrap valign="top"><textarea name="Comments" rows="10" cols="65" tabindex="8"></textarea></td>
	</tr>
</table>
<hr>
<table cellpadding="1" cellspacing="1">
...
<input type="hidden" name="ClassBundle">
