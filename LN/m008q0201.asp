...
<div class="BrowsePanel" style="width: 100%; height: 220px"> 
  <table cellpadding="2" cellspacing="1">
    <tr> 
      ...
      <th nowrap class="headrow" align="center">Is Backordered</th>
      ...
      <th nowrap class="headrow" align="left">Total</th>
    </tr>
<% 
var total_cost = 0;
var total;
...
%>
    <tr> 
      <td nowrap><a href="m008e0201.asp?intLoan_req_id=<%=Request.QueryString("intLoan_req_id")%>&intEqpReq_Id=<%=(rsInventoryRequested.Fields.Item("intEqpReq_Id").Value)%>"><%=((rsInventoryRequested.Fields.Item("bitIs_class").Value=="1")?rsInventoryRequested.Fields.Item("chvEqp_Class_Name").Value:rsInventoryRequested.Fields.Item("chvEqp_Bundle_Name").Value)%></a>&nbsp;</td>
      <td nowrap><%=((rsInventoryRequested.Fields.Item("bitIs_class").Value=="1")?"Class":"Bundle")%></td>
      <td align="center" nowrap><%=(rsInventoryRequested.Fields.Item("bitIs_BO").Value)%>&nbsp;</td>
      <td align="center" nowrap><%=(rsInventoryRequested.Fields.Item("insQuantity").Value)%>&nbsp;</td>
      <td align="left"><%=(rsInventoryRequested.Fields.Item("chvComments").Value)%>&nbsp;</td>
      <td align="right" nowrap><%=FormatCurrency(rsInventoryRequested.Fields.Item("fltList_unit_cost").Value)%>&nbsp;</td>
      <td align="right" nowrap><%=FormatCurrency(total)%>&nbsp;</td>
    </tr>
    <%
...
%>
    <tr> 
      <td nowrap colspan="7" style="font-size: 7pt"> &nbsp;&nbsp;-&nbsp;<%=rsBundleComponent.Fields.Item("chvEqCls_name").Value%></td>
    </tr>
    <%
...
<table cellpadding="1" cellspacing="1">
	<tr> 
    	<td><a href="javascript: openWindow('m008a0201.asp?intLoan_req_id=<%=Request.QueryString("intLoan_req_id")%>','w008A02');">Add Equipment Request</a></td>
	</tr>
</table>
</div>
</body>
