...
%>
    <tr> 
<!-- + Nov.03.2005
      <td nowrap align="left"><a href="m008e0301.asp?intEqp_Loaned_Id=<%=rsInventoryLoaned.Fields.Item("intEqp_Loaned_Id").Value%>&intLoan_Req_id=<%=Request.QueryString("intLoan_Req_id")%>"><%=(rsInventoryLoaned.Fields.Item("chvInventory_Name").Value)%></a>&nbsp;</td>
-->
