...
<head>
	...
	function JumpRecord(){
		if (document.frmr01.JumpToRecord.value=="") alert("Enter Record Number.");
...
<table cellspacing="1">
  ...
  <div class="BrowsePanel" style="width: 100%; height: 400px"> 
    <table cellpadding="2" cellspacing="1" class="Mtable">
      <tr> 
        ...
        <th nowrap class="headrow" align="left">Priority Rank</th>
...
<table cellpadding="1" cellspacing="1">
	<tr>
		<td width="900"><a href="javascript: openWindow('m008a0101.asp','wQA01');">Add Loan Request</a></td>
